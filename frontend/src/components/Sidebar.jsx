...
// Admin-only nav entry, appended to NAV when the signed-in user is an admin.
const ADMIN_NAV = { id: 'admin', label: 'Admin', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' };
